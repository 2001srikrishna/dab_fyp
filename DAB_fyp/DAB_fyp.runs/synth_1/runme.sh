...
HD_PWD='/home/srikri/DAB_fyp/DAB_fyp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log avg_and_DPID.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source avg_and_DPID.tcl
